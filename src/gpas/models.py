...
from src.gpas.db import Model
from iso3166 import countries
from sqlalchemy.dialects.postgresql import ARRAY
from sqlalchemy.ext.mutable import MutableList
from src.gpas.constants import ValueType, SequenceCategory, NucleicAcidType, db_user, db_timestamp
...
class Sample(GpasLocalModel):
    ...
    sequence_category: Mapped[SequenceCategory] = mapped_column(Enum(
        *get_args(SequenceCategory),
