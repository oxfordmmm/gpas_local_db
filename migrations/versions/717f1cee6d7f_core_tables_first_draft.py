...
Revision ID: 717f1cee6d7f
Revises: 
Create Date: 2024-01-17 14:02:06.355261
...
def upgrade() -> None:
    ...
    sa.Column('user', sa.String(length=5), nullable=False),
    sa.Column('number_samples', sa.Integer(), nullable=False),
    sa.Column('flowcell', sa.String(length=20), nullable=False),
    sa.Column('passed_qc', sa.Boolean(), nullable=False),
    ...
    sa.Column('collection_site', sa.String(length=50), nullable=False),
    sa.Column('specimen_type', sa.String(length=50), nullable=False),
    sa.Column('qr_code', sa.Text(), nullable=False),
    sa.Column('bar_code', sa.Text(), nullable=False),
    sa.Column('created_by', sa.String(length=50), server_default=sa.text('(USER())'), nullable=False),
    sa.Column('created_at', mysql.TIMESTAMP(fsp=3), server_default=sa.text('CURRENT_TIMESTAMP(3)'), nullable=False),
    sa.Column('updated_by', sa.String(length=50), server_default=sa.text('(USER())'), nullable=False),
    sa.Column('updated_at', mysql.TIMESTAMP(fsp=3), server_default=sa.text('CURRENT_TIMESTAMP(3)'), nullable=False),
    ...
    sa.Column('sequence_type', sa.Enum('Isolate', 'Metagenome', name='sequence_type', create_constraint=True), nullable=True),
    sa.Column('nucleic_acid_type', mysql.SET('DNA', 'RNA', 'cDNA'), nullable=True),
    sa.Column('created_by', sa.String(length=50), server_default=sa.text('(USER())'), nullable=False),
    sa.Column('created_at', mysql.TIMESTAMP(fsp=3), server_default=sa.text('CURRENT_TIMESTAMP(3)'), nullable=False),
    sa.Column('updated_by', sa.String(length=50), server_default=sa.text('(USER())'), nullable=False),
    sa.Column('updated_at', mysql.TIMESTAMP(fsp=3), server_default=sa.text('CURRENT_TIMESTAMP(3)'), nullable=False),
