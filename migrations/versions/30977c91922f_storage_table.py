...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['specimen_id'], ['specimens.id'], name=op.f('fk_storages_specimen_id_specimens')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_storages')),
    sa.UniqueConstraint('storage_qr_code', name=op.f('uq_storages_storage_qr_code'))
    )
